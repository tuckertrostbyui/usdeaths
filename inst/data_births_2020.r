data_births_2020 <- tribble(
  ...
  # NOTE: MBRACE dropped from 2020 public use file; position 110 is now filler
  ...
  # NOTE: MHISPX in 2020 includes Dominican (code 5); codes 4→5→6 (unlike 2018 which jumped 4→6)
  ...
  # NOTE: DMAR for Puerto Rico has extended codes: 1=Yes/Married, 2=Unmarried parents living together,
  #       3=Unmarried parents not living together, 9=Unknown or not stated
  ...
  # NOTE: 2020 guide lists BMI_R code 4 as "Obesity I 35.0-34.9" (apparent typo carried from earlier guides; should be 30.0-34.9)
  ...
  # NOTE: Code 3 is "CNM/CM" in 2020 (Certified Nurse Midwife/Certified Midwife); was "CNM" in 2018
  "attend",                     433,  433,    1,  "int",  "Attendant at Birth",                                             "1=Doctor of Medicine (MD)|2=Doctor of Osteopathy (DO)|3=Certified Nurse Midwife (CNM/CM)|4=Other Midwife|5=Other|9=Unknown or not stated",
  ...
  # NOTE: DPLURAL in 2020 tops out at code 4 = "Quadruplet or higher"; 2018 had a separate code 5
...
usethis::use_data(data_births_2020, overwrite = TRUE)