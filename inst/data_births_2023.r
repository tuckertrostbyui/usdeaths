data_births_2023 <- tribble(
  ...
  # NOTE: MBRACE dropped from 2022+ public use file; position 110 is now filler
  ...
  # NOTE: MHISPX includes Dominican (code 5) starting with 2018 data;
  #       starting 2023, "Latin American" moved from code 4 to code 6
  ...
  # NOTE: DMAR has expanded codes for Puerto Rico (codes 1/2/3/9)
  "dmar",                       120,  120,    1,  "int",  "Marital Status",                                                 "1=Married (US) / Yes (PR)|2=Unmarried (US) / Unmarried parents living together (PR)|3=Unmarried parents not living together (PR)|9=Unknown or not stated (PR)",
  ...
  "bmi_r",                      287,  287,    1,  "int",  "Body Mass Index Recode",                                         "1=Underweight <18.5|2=Normal 18.5-24.9|3=Overweight 25.0-29.9|4=Obesity I 35.0-34.9|5=Obesity II 35.0-39.9|6=Extreme Obesity III ≥40.0|9=Unknown or not stated",
  ...
  # NOTE: Code 3 updated to "CNM/CM" (Certified Nurse Midwife/Certified Midwife) in 2022+
  ...
  # NOTE: DPLURAL code 4 = "Quadruplet or higher" in 2023 (2018 had separate code 5)
...
usethis::use_data(data_births_2023, overwrite = TRUE)