data_births_2018 <- tribble(
  ...
  # NOTE: MBRACE present in 2018 only; dropped from 2022+ public use file
  ...
  # NOTE: MHISPX in 2018 has no Dominican category (code 5); codes jump 4→6
  ...
  # NOTE: 2018 guide lists BMI_R code 4 as "Obesity I 35.0-34.9" (apparent typo in PDF; should be 30.0-34.9)
  ...
  # NOTE: Code 3 is "CNM" in 2018 (Certified Nurse Midwife); 2022 updated to "CNM/CM"
  "attend",                     433,  433,    1,  "int",  "Attendant at Birth",                                             "1=Doctor of Medicine (MD)|2=Doctor of Osteopathy (DO)|3=Certified Nurse Midwife (CNM)|4=Other Midwife|5=Other|9=Unknown or not stated",
  ...
  # NOTE: DPLURAL code 5 = "Quintuplet or higher" in 2018; 2022 stops at 4 (Quadruplet or higher)
  "dplural",                    454,  454,    1,  "int",  "Plurality Recode",                                               "1=Single|2=Twin|3=Triplet|4=Quadruplet|5=Quintuplet or higher",
...
usethis::use_data(data_births_2018, overwrite = TRUE)